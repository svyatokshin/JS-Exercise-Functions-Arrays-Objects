 ...
 * }
*/
function makePersonObject(varId, varName, varEmail) {
  let personObject = {
    id: varId,
    name: varName,
    email: varEmail
...
*/
function makeSmartPerson(varName) {
  return {
    name: varName,
    ...
    speak: function(){
      return `Hello, my name is ${varName}`
    } // ends speak function
  }
}
...
*/
function getOlderCars(inventory, maxYear) {    //look at this code later
  const newArray = [];
  for(let i = 0; i < inventory.length; i++){
